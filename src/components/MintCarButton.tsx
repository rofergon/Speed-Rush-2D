...
export function MintCarButton() {
  ...
  const handleMint = async () => {
    ...
    try {
      ...
      console.log('Dirección del usuario:', account.bech32Address);
      console.log('Contrato del tesoro:', GAME_CONTRACTS.TREASURY);
      ...
      toast.error(error.message || 'Error al mintear el carro');
    } finally {
      setIsMinting(false);
    }
  };
